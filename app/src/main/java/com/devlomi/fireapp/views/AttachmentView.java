package com.bbt.ghostroom.views;
...
public class AttachmentView extends RelativeLayout implements View.OnClickListener {
    ...
    private void animate(View view) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
            ...
            SupportAnimator animator = io.codetail.animation.ViewAnimationUtils
                    .createCircularReveal(cardViewAttachments, cx, cy, 0, finalRadius);
            ...
            if (!isOpen) {
                Animator anim = android.view.ViewAnimationUtils.createCircularReveal(cardViewAttachments, cx, cy, 0,
                        finalRadius);
                cardViewAttachments.setVisibility(View.VISIBLE);
                ...
                Animator anim = android.view.ViewAnimationUtils.createCircularReveal(cardViewAttachments, cx, cy,
                        finalRadius, 0);
    ...
    private void bounceAnimations() {
        ...
        set.playTogether(galleryScaleX, galleryScaleY, cameraScaleX, cameraScaleY, audioScaleX, audioScaleY,
                documentScaleX, documentScaleY, locationScaleX, locationScaleY, contactScaleX, contactScaleY);
        set.start();
