package com.bbt.ghostroom.placespicker
...
import com.bbt.ghostroom.common.extensions.toLatLng
import com.bbt.ghostroom.common.extensions.toLatLngString
...
class PlacesPickerViewModel(
    ...
    // Updated: Callbacks use NON-NULL parameters now
    ...
    private fun getCurrentPlace(latLng: LatLng) {
        launch {
            try {
                val response = placesWebService
                    .getNearbyPlaces(latLng.toLatLngString())
                    .await()
