...
package com.bbt.ghostroom.activities.calling
...
import com.bbt.ghostroom.activities.calling.event.CallingStateEvent
import com.bbt.ghostroom.activities.calling.event.CallingViewState
import com.bbt.ghostroom.activities.calling.model.CallType
import com.bbt.ghostroom.activities.calling.model.CallingState
import com.bbt.ghostroom.activities.calling.model.EngineConfig
import com.bbt.ghostroom.common.extensions.unBindServiceSafely
import com.bbt.ghostroom.extensions.finishAndRemoveTaskCompat
import com.bbt.ghostroom.model.ImageItem
...
import com.bbt.ghostroom.services.CallingService
...
import com.bbt.ghostroom.utils.network.FireManager.Companion.checkAndDownloadUserPhoto
import com.bbt.ghostroom.utils.network.FireManager.Companion.fetchUserByUid
import com.bbt.ghostroom.utils.network.GroupManager
import com.bbt.ghostroom.views.CallingGridLayout
    ...
    override fun onServiceConnected(componentName: ComponentName, iBinder: IBinder) {
        if (CallingService::class.java.name == componentName.className) {
            ...
            when (action) {
                ...
                IntentUtils.NOTIFICATION_ACTION_ANSWER -> {
                    RealmHelper.getInstance().getFireCall(mCallId)?.let { fireCall ->
                        if (fireCall.direction == FireCallDirection.INCOMING && 
                            !TimeHelper.isTimePassedBySeconds(
                                System.currentTimeMillis(),
                                fireCall.timestamp,
