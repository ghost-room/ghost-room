package com.bbt.ghostroom.activities.main.messaging;
...
import static com.bbt.ghostroom.model.constants.DownloadUploadStat.CANCELLED;
import static com.bbt.ghostroom.model.constants.DownloadUploadStat.FAILED;
import static com.bbt.ghostroom.model.constants.DownloadUploadStat.LOADING;
import static com.bbt.ghostroom.utils.FireConstants.presenceRef;
import static com.bbt.ghostroom.utils.IntentUtils.EXTRA_CURRENT_ALBUM_POSITION;
import static com.bbt.ghostroom.utils.IntentUtils.EXTRA_CURRENT_MESSAGE_ID;
import static com.bbt.ghostroom.utils.IntentUtils.EXTRA_STARTING_POSITION;
...
import com.bbt.ghostroom.activities.BaseActivity;
import com.bbt.ghostroom.activities.CameraActivity;
import com.bbt.ghostroom.activities.ContactDetailsActivity;
import com.bbt.ghostroom.activities.ForwardActivity;
import com.bbt.ghostroom.activities.FullscreenActivity;
import com.bbt.ghostroom.activities.SelectContactNumbersActivity;
import com.bbt.ghostroom.activities.UserDetailsActivity;
import com.bbt.ghostroom.activities.ViewStatusActivity;
import com.bbt.ghostroom.activities.main.messaging.swipe.MessageSwipeController;
import com.bbt.ghostroom.activities.main.messaging.swipe.SwipeControllerActions;
import com.bbt.ghostroom.adapters.messaging.AudibleInteraction;
import com.bbt.ghostroom.adapters.messaging.ContactHolderInteraction;
import com.bbt.ghostroom.adapters.messaging.Interaction;
import com.bbt.ghostroom.adapters.messaging.MessagingAdapter;
import com.bbt.ghostroom.events.AudioServiceCallbacksEvent;
import com.bbt.ghostroom.events.GroupActiveStateChanged;
import com.bbt.ghostroom.events.HeadsetStateChanged;
import com.bbt.ghostroom.events.OnNetworkComplete;
import com.bbt.ghostroom.events.UpdateGroupEvent;
import com.bbt.ghostroom.events.UpdateNetworkProgress;
import com.bbt.ghostroom.model.ExpandableContact;
import com.bbt.ghostroom.model.ProgressData;
import com.bbt.ghostroom.model.constants.DownloadUploadStat;
import com.bbt.ghostroom.model.constants.MessageStat;
import com.bbt.ghostroom.model.constants.MessageType;
import com.bbt.ghostroom.model.constants.TypingStat;
import com.bbt.ghostroom.model.realms.Chat;
import com.bbt.ghostroom.model.realms.Group;
import com.bbt.ghostroom.model.realms.Message;
import com.bbt.ghostroom.model.realms.PhoneNumber;
import com.bbt.ghostroom.model.realms.QuotedMessage;
import com.bbt.ghostroom.model.realms.RealmContact;
import com.bbt.ghostroom.model.realms.Status;
import com.bbt.ghostroom.model.realms.User;
import com.bbt.ghostroom.placespicker.Place;
import com.bbt.ghostroom.placespicker.PlacesPickerActivity;
import com.bbt.ghostroom.receivers.HeadsetReceiver;
import com.bbt.ghostroom.services.AudioService;
import com.bbt.ghostroom.utils.AdapterHelper;
import com.bbt.ghostroom.utils.BitmapUtils;
import com.bbt.ghostroom.utils.BuildVerUtil;
import com.bbt.ghostroom.utils.ClipboardUtil;
import com.bbt.ghostroom.utils.ContactUtils;
import com.bbt.ghostroom.utils.DirManager;
import com.bbt.ghostroom.utils.DownloadManager;
import com.bbt.ghostroom.utils.DpUtil;
import com.bbt.ghostroom.utils.FileFilter;
import com.bbt.ghostroom.utils.FileUtils;
import com.bbt.ghostroom.utils.FireConstants;
import com.bbt.ghostroom.utils.FireListener;
import com.bbt.ghostroom.utils.GroupTyping;
import com.bbt.ghostroom.utils.IntentUtils;
import com.bbt.ghostroom.utils.MessageCreator;
import com.bbt.ghostroom.utils.MessageTypeHelper;
...
import com.bbt.ghostroom.utils.RecorderSettings;
...
import com.bbt.ghostroom.utils.UriStringMapper;
import com.bbt.ghostroom.utils.Util;
import com.bbt.ghostroom.utils.keyboard.KeyboardHelper;
import com.bbt.ghostroom.utils.mediastore.MediaStoreFileInfo;
import com.bbt.ghostroom.utils.network.FireManager;
import com.bbt.ghostroom.utils.network.GroupManager;
import com.bbt.ghostroom.views.AnimButton;
import com.bbt.ghostroom.views.AttachmentView;
import com.bbt.ghostroom.views.ChatEditText;
import com.bbt.ghostroom.views.dialogs.DeleteDialog;
import com.bbt.ghostroom.views.dialogs.DialogChoseNumber;
import com.bbt.ghostroom.views.sticker.FireStickerProvider;
...
//    AXEmojiPopupLayout emojiPopupLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(typingLayoutContainer, (v, windowInsets) -> {
        ...
        ViewCompat.setWindowInsetsAnimationCallback(
                ...
                new WindowInsetsAnimationCompat.Callback(WindowInsetsAnimationCompat.Callback.DISPATCH_MODE_STOP) {
                    ...
                    public WindowInsetsCompat onProgress(
                        ...
                        int bottomPadding = imeInsets.bottom  > 0 ? imeInsets.bottom : systemBarsInsets.bottom;

                        int currentLeftPadding = typingLayoutContainer.getPaddingLeft();
                        int currentTopPadding = typingLayoutContainer.getPaddingTop();
                        int currentRightPadding = typingLayoutContainer.getPaddingRight();

                        typingLayoutContainer.setPadding(currentLeftPadding, currentTopPadding, currentRightPadding, bottomPadding);
                ...
                .withListener(new PermissionListener() {
                    ...
                    public void onPermissionGranted(PermissionGrantedResponse permissionGrantedResponse) {
                        new MultiContactPicker.Builder(ChatActivity.this)
                                .theme(R.style.MyCustomContactPickerTheme)
