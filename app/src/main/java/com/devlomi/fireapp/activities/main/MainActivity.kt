package com.bbt.ghostroom.activities.main
...
import com.bbt.ghostroom.activities.*
import com.bbt.ghostroom.activities.settings.SettingsActivity
import com.bbt.ghostroom.adapters.ViewPagerAdapter
import com.bbt.ghostroom.common.ViewModelFactory
import com.bbt.ghostroom.common.extensions.findFragmentByTagForViewPager
...
import com.bbt.ghostroom.extensions.observeValueEvent
import com.bbt.ghostroom.fragments.BaseFragment
import com.bbt.ghostroom.interfaces.FragmentCallback
import com.bbt.ghostroom.interfaces.StatusFragmentCallbacks
import com.bbt.ghostroom.job.DailyBackupJob
import com.bbt.ghostroom.job.SaveTokenJob
import com.bbt.ghostroom.job.SetLastSeenJob
import com.bbt.ghostroom.model.realms.User
import com.bbt.ghostroom.services.FCMRegistrationService
import com.bbt.ghostroom.services.InternetConnectedListener
import com.bbt.ghostroom.services.NetworkService
import com.bbt.ghostroom.utils.*
import com.bbt.ghostroom.utils.network.FireManager
import com.bbt.ghostroom.views.dialogs.IgnoreBatteryDialog
import com.bbt.ghostroom.views.sticker.StickerLoader
...
class MainActivity : BaseActivity(), FabRotationAnimation.RotateAnimationListener, FragmentCallback,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(fab) { v, windowInsets ->
            ...
            fabBottomInset = insets.bottom + fab.paddingBottom
            v.updateLayoutParams<ViewGroup.MarginLayoutParams> {
                leftMargin = insets.left + fab.paddingLeft
                bottomMargin = fabBottomInset
                rightMargin = insets.right + fab.paddingRight
            }

            WindowInsetsCompat.CONSUMED
        }

        viewPager.setInsetPadding()
    ...
    override fun addMarginToFab(isAdShowing: Boolean) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(fab) { view, windowInsets ->
            ...
            view.updateLayoutParams<ViewGroup.MarginLayoutParams> {
                leftMargin = insets.left + fab.paddingLeft
                bottomMargin = fabBottomInset+v.toInt()
                rightMargin = insets.right + fab.paddingRight
            }
