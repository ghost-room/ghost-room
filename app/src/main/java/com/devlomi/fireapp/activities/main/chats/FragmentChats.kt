...
import com.bbt.ghostroom.activities.ProfilePhotoDialog
import com.bbt.ghostroom.activities.main.MainViewModel
import com.bbt.ghostroom.activities.main.chats.ChatsAdapter.ChatsHolder
...
import com.bbt.ghostroom.utils.GroupTyping.GroupTypingListener
...
class FragmentChats : BaseFragment(), GroupTypingListener, ActionMode.Callback, ChatsAdapter.ChatsAdapterCallback {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        val btnOffline = view.findViewById<Button>(R.id.btn_offline)
