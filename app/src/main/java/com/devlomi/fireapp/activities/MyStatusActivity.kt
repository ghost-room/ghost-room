...
import com.bbt.ghostroom.adapters.MyStatusAdapter
...
class MyStatusActivity : BaseActivity(), ActionMode.Callback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fetchSeenCount()
        rvMyStatus.setInsetPadding()
        fab.setInsetPadding(plusLeft = fab.marginLeft, plusBottom = 36, plusRight = fab.marginRight)
