...
import com.bbt.ghostroom.model.constants.SensorState;
import com.bbt.ghostroom.utils.AudioHelper;
...
import com.bbt.ghostroom.utils.ProximitySensor;
...
public class AudioService extends Service implements AudioManager.OnAudioFocusChangeListener, ProximitySensor.Delegate {
    ...
    private void startForeground() {
        ServiceCompat.startForeground(this, NotificationHelper.ID_NOTIFICATION_AUDIO,
                new NotificationHelper(this).getAudioNotification(), FOREGROUND_SERVICE_TYPE_MEDIA_PLAYBACK);
    }
