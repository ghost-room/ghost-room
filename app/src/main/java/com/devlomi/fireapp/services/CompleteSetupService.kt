...
import com.bbt.ghostroom.activities.setup.SetupUserUseCase
import com.bbt.ghostroom.extensions.writeToFile
import com.bbt.ghostroom.extensions.unzip
...
class CompleteSetupService : LifecycleService() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        intent?.let { intent ->
            ...
            ServiceCompat.startForeground(this,notificationId, notification!!.build(), FOREGROUND_SERVICE_TYPE_DATA_SYNC)
