package com.bbt.ghostroom.services
...
import com.bbt.ghostroom.activities.calling.AgoraConfig
...
import com.bbt.ghostroom.activities.calling.model.*
import com.bbt.ghostroom.common.extensions.abandonAudioFocusCompat
import com.bbt.ghostroom.common.extensions.requestAudioFocusCompat
...
//                            }
                    ...
                    IntentUtils.NOTIFICATION_ACTION_DECLINE -> {
                        if (fireCall == null) {
                            fireCall = RealmHelper.getInstance().getFireCall(callId)
