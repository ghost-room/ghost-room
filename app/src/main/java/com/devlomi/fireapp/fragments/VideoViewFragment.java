package com.bbt.ghostroom.fragments;
...
public class VideoViewFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(seekbarContainer, (v, windowInsets) -> {
            Insets insets = windowInsets.getInsets(WindowInsetsCompat.Type.systemBars());
            if (v.getLayoutParams() instanceof ViewGroup.MarginLayoutParams) {
                ViewGroup.MarginLayoutParams params = (ViewGroup.MarginLayoutParams) v.getLayoutParams();
                params.setMargins(insets.left + params.leftMargin, 0, insets.right + params.rightMargin,
                        insets.bottom + params.bottomMargin);
