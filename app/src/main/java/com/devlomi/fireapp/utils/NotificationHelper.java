...
import static com.bbt.ghostroom.utils.IntentUtils.NOTIFICATION_ACTION_DECLINE;
import static com.bbt.ghostroom.utils.MessageTypeHelper.getMessageContent;
...
import com.bbt.ghostroom.activities.BackupChatActivity;
...
import com.bbt.ghostroom.activities.setup.SetupUserActivity;
...
import com.bbt.ghostroom.receivers.HandleReplyReceiver;
import com.bbt.ghostroom.receivers.MarkAsReadReceiver;
...
//        start chatActivity with the clicked user
    ...
    public void createMissedCallNotification(User user, String phone) {
        ...
        PendingIntent contentIntent = PendingIntent.getActivity(this, flagUpdateCurrent,
