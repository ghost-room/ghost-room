...
import com.bbt.ghostroom.activities.calling.model.AGEventHandler
import com.bbt.ghostroom.activities.calling.model.EngineConfig
import com.bbt.ghostroom.activities.calling.model.MyEngineEventHandler
import com.bbt.ghostroom.job.FireJobCreator
...
class MyApp : Application(), ActivityLifecycleCallbacks {
    ...
    fun ringtonePlayer() = ringtonePlayer
