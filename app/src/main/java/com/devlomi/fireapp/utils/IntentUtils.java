...
public class IntentUtils {
    ...
    public static Intent getOpenFileIntent(Context context, String path) {
        ...
        if (fileExtension.equalsIgnoreCase("apk")) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                Uri uriForFile = FileProvider.getUriForFile(context, context.getPackageName() + ".provider", toInstall);
    ...
    public static Intent getSendEmailIntent(Context context) {
        ...
        emailIntent.putExtra(Intent.EXTRA_SUBJECT,
                context.getString(R.string.app_name) + " " + context.getString(R.string.feedback));
    ...
    public static Intent getShareAppIntent(Context context) {
        ...
        String link = "https://play.google.com/store/apps/details?id=" + appPackageName;// app link is auto generated by
                                                                                        // using package name
